...
//        synchronizeFiles(inputStream, outputStream);
        ...
        downloadFiles(outputStream, inputStream);
     ...
     */
    private void synchronizeFiles(DataInputStream inputStream, DataOutputStream outputStream) {

        int cnt;
        HashMap<String, Integer> map = new HashMap<>();
        HashMap<String, LinkedList<File>> dirAndFiles = new HashMap<>();
        String[] dirNames = new String[0];
        File dir = new File("C:\\Users\\Linkdamo\\Desktop\\receiver\\");
        if (!dir.exists()) {
            dir.mkdirs();
        } else {
     ...
     */
    private void downloadFiles(DataOutputStream outputStream, DataInputStream inputStream) {
        try {
     ...
     * @param inputStream 输入流
     */
    private void receiveFiles(DataOutputStream outputStream, DataInputStream inputStream) {
        try {
            //创建文件夹
...
send files
*/
    private boolean sendFiles(DataOutputStream outputStream, File file) {
        boolean r = false;
        try {
//            File file = new File("C:\\Users\\Linkdamo\\Desktop\\证明2.jpg");
            if (file.exists()) {
